...
const sections = [
  { heading: "Test Levels", badge: "bg-lime-500/15 text-lime-400 border-lime-500/30", items: [
    ...
    { title: "E2E Testing with Playwright", description: "Page objects, auto-waiting, assertions, and CI integration.", href: "/testing/playwright" },
  ]},
  { heading: "Tools & Frameworks", badge: "bg-cyan-500/15 text-cyan-400 border-cyan-500/30", items: [
    { title: "xUnit & NUnit (.NET)", description: "Test lifecycle, fixtures, parameterized tests, and assertions.", href: "/testing/xunit-nunit" },
    { title: "Jest & React Testing Library", description: "Component testing, user-event, snapshots, and custom renders.", href: "/testing/jest-rtl" },
    { title: "Mocking & Dependency Isolation", description: "Moq, NSubstitute, jest.mock — when to mock and when NOT to.", href: "/testing/mocking" },
  ]},
  { heading: "Practices & Quality", badge: "bg-purple-500/15 text-purple-400 border-purple-500/30", items: [
    ...
    { title: "Performance & Load Testing", description: "k6, JMeter, identifying bottlenecks, and setting baselines.", href: "/testing/performance" },
  ]},
];
  ...
  return (
    <MotionFade>
      <div className="max-w-6xl">
        <div className="mb-10">
          <h1 className="text-3xl font-bold mb-3 tracking-tight" style={{ fontFamily: "var(--font-heading)" }}>Testing Strategies & Tools</h1>
          <p className="text-text-secondary max-w-2xl leading-relaxed">How automated testing works at every layer — from unit tests with Jest and xUnit to end-to-end testing with Playwright and performance profiling.</p>
        </div>
        <CategoryConceptTree nodes={conceptNodes} edges={conceptEdges} accentColor="#84cc16" groupColors={groupColors} title="Testing Pyramid & Tools" height={470} />
