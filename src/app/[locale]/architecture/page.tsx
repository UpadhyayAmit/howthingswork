...
const sections = [
  { heading: "Foundation", badge: "bg-emerald-500/15 text-emerald-400 border-emerald-500/30", items: [
    { title: "SOLID Principles", description: "SRP, OCP, LSP, ISP, DIP — with real C# and TypeScript code examples.", href: "/architecture/solid" },
    { title: "OOP: 4 Pillars in Practice", description: "Encapsulation, Inheritance, Polymorphism, Abstraction — beyond the textbook.", href: "/architecture/oop" },
  ]},
  { heading: "Architecture", badge: "bg-cyan-500/15 text-cyan-400 border-cyan-500/30", items: [
    { title: "Clean Architecture", description: "Layers, dependency rule, use cases, and how to structure a real project.", href: "/architecture/clean-architecture" },
    { title: "Domain-Driven Design (DDD)", description: "Aggregates, entities, value objects, bounded contexts, and ubiquitous language.", href: "/architecture/ddd" },
  ]},
  { heading: "Design Patterns", badge: "bg-purple-500/15 text-purple-400 border-purple-500/30", items: [
    { title: "Repository & Unit of Work", description: "Data access abstraction, transaction boundaries, and testability.", href: "/architecture/repository-pattern" },
    { title: "CQRS & Event Sourcing", description: "Command/Query split, event stores, and rebuilding state from events.", href: "/architecture/cqrs" },
    { title: "Mediator & MediatR", description: "Request/handler pipeline, decoupled handlers, and pipeline behaviors.", href: "/architecture/mediator" },
    { title: "Strategy, Factory, Observer", description: "Gang of Four patterns you'll use every day in production code.", href: "/architecture/design-patterns" },
    { title: "Decorator & Chain", description: "The middleware pattern — cross-cutting concerns like logging and caching.", href: "/architecture/decorator-chain" },
  ]},
  { heading: "Quality", badge: "bg-red-500/15 text-red-400 border-red-500/30", items: [
    { title: "Anti-Patterns & Code Smells", description: "God object, service locator, over-engineering — what NOT to do.", href: "/architecture/anti-patterns" },
  ]},
];
  ...
  return (
    <MotionFade>
      <div className="max-w-6xl">
        <div className="mb-10">
          <h1 className="text-3xl font-bold mb-3 tracking-tight" style={{ fontFamily: "var(--font-heading)" }}>Architecture & Design Patterns</h1>
          <p className="text-text-secondary max-w-2xl leading-relaxed">How software systems are structured for maintainability, testability, and scale — from SOLID principles to advanced DDD and event sourcing.</p>
        </div>
        <CategoryConceptTree nodes={conceptNodes} edges={conceptEdges} accentColor="#10b981" groupColors={groupColors} title="Architecture Concept Map" height={370} />
