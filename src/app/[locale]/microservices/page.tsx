    ...
    items: [
      {
        ...
        description: 'When to split, strangler fig pattern, and the hidden costs of distribution.',
        href: '/microservices/monolith-vs-micro',
      },
      { title: 'API Gateway Pattern', description: 'Routing, aggregation, BFF, and gateway offloading.', href: '/microservices/api-gateway' },
      {
        ...
        description: 'DNS, Consul, client-side vs server-side LB, and health checks.',
        href: '/microservices/service-discovery',
      },
    ],
  },
  {
    ...
    items: [
      {
        ...
        description: 'REST vs gRPC vs messaging — sync vs async trade-offs.',
        href: '/microservices/communication',
      },
      {
        title: 'Circuit Breaker & Resilience',
        description: 'Polly, retry policies, bulkhead isolation, and timeout strategies.',
        href: '/microservices/circuit-breaker',
      },
      { title: 'Saga Pattern', description: 'Choreography vs orchestration for cross-service transactions.', href: '/microservices/saga' },
      {
        ...
        description: 'Event bus, eventual consistency, outbox pattern, and idempotency.',
        href: '/microservices/event-driven',
      },
    ],
  },
  {
    ...
    items: [
      ...
      { title: 'Observability', description: 'Distributed tracing, correlation IDs, and Grafana/Prometheus.', href: '/microservices/observability' },
      {
        ...
        description: 'Database-per-service, data sync strategies, and CQRS for reads.',
        href: '/microservices/data-management',
      },
    ],
  },
];
      ...
      <div className="max-w-6xl">
        <div className="mb-10">
          ...
          <p className="text-text-secondary max-w-2xl leading-relaxed">
            How distributed systems communicate, scale, and stay resilient — from monolith decomposition to event-driven sagas and container
            orchestration.
          </p>
        </div>
        <CategoryConceptTree
