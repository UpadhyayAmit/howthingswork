...
const sections = [
  {
    ...
    items: [
      { title: "Fiber Architecture", description: "How React Fiber builds and traverses the fiber tree using depth-first work loops.", href: "/react/fiber-visualizer" },
      { title: "Virtual DOM & Diffing", description: "How React creates a virtual representation of the UI and diffs it to find minimal changes.", href: "/react/virtual-dom" },
      { title: "Reconciliation", description: "The algorithm React uses to compare old and new trees and decide what to update.", href: "/react/reconciliation" },
      { title: "Rendering Pipeline", description: "The full journey from JSX to pixels — render phase, commit phase, and browser paint.", href: "/react/rendering-pipeline" },
    ],
  },
  {
    heading: "Component Model",
    items: [
      { title: "Component Lifecycle", description: "Mount, update, and unmount phases — how React manages component instances.", href: "/react/component-lifecycle" },
      { title: "Error Boundaries", description: "How React catches errors in the component tree and renders fallback UI.", href: "/react/error-boundaries" },
      { title: "Portals", description: "Rendering children into a different DOM node outside the parent hierarchy.", href: "/react/portals" },
      { title: "Keys & List Rendering", description: "How the key prop helps React efficiently reconcile lists and avoid unnecessary re-mounts.", href: "/react/keys-lists" },
    ],
  },
  {
    heading: "Hooks & State",
    items: [
      { title: "Hooks Internals", description: "How React stores hooks as a linked list on each fiber node and walks them every render.", href: "/react/hooks-visualizer" },
      { title: "useEffect Lifecycle", description: "Setup, cleanup, and dependency tracking — when effects run and why.", href: "/react/useeffect-lifecycle" },
      { title: "State & Batching", description: "How setState queues updates, batches them, and triggers a single re-render.", href: "/react/state-batching" },
      { title: "Memoization (useMemo/useCallback)", description: "How React caches computed values and function references across renders.", href: "/react/memoization" },
      { title: "React.memo & Re-renders", description: "When and why components re-render, and how React.memo prevents unnecessary renders.", href: "/react/react-memo" },
      { title: "Refs & DOM Access", description: "How useRef persists values across renders and provides direct DOM access.", href: "/react/refs-dom" },
    ],
  },
  {
    heading: "Data Flow & Events",
    items: [
      { title: "Context API", description: "How React propagates context values down the tree and triggers consumer re-renders.", href: "/react/context-api" },
      { title: "Event System (SyntheticEvent)", description: "React's event delegation, synthetic event pooling, and bubbling mechanism.", href: "/react/event-system" },
    ],
  },
  {
    heading: "React 18+ Features",
    items: [
      { title: "Concurrent Rendering", description: "Time slicing, priority lanes, and interruptible rendering in React 18+.", href: "/react/concurrent-rendering" },
      { title: "Suspense & React.lazy", description: "Fallback rendering, code splitting, and streaming SSR boundaries.", href: "/react/suspense" },
      { title: "Transitions (useTransition)", description: "Priority-based rendering — urgent vs non-urgent updates with startTransition.", href: "/react/transitions" },
      { title: "Server Components (RSC)", description: "Server/client boundary, RSC payload streaming, and zero-bundle server rendering.", href: "/react/server-components" },
    ],
  },
];
      ...
      <div className="max-w-6xl">
        <div className="mb-10">
          ...
          <p className="text-text-secondary max-w-2xl leading-relaxed">
            A comprehensive visual guide to how React works under the hood — from fiber
            architecture to concurrent rendering. Each visualizer lets you step through
