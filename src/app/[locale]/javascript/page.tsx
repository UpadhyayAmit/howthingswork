...
import CategoryConceptTree, { type ConceptNode, type ConceptEdge, type NodeShape } from '@/app/_ui/CategoryConceptTree';
    ...
    items: [
      {
        ...
        description: 'How JavaScript handles async operations with a single thread — task queue, microtask queue, and the render cycle.',
        href: '/javascript/event-loop',
      },
      {
        title: 'Web APIs & Browser Runtime',
        description: 'How setTimeout, fetch, requestAnimationFrame, and other Web APIs integrate with the JS engine.',
        href: '/javascript/web-apis',
      },
    ],
  },
  {
    ...
    items: [
      {
        ...
        description: 'Promise resolution, microtask queue priority, and how .then() chains schedule work.',
        href: '/javascript/promises',
      },
      {
        title: 'Async/Await Internals',
        description: 'How the compiler transforms async functions into generator-based state machines.',
    ...
    items: [
      {
        ...
        description: 'How lexical scoping works, closure memory model, and variable capture.',
        href: '/javascript/closures',
      },
      {
        title: 'this Binding Rules',
        description: '4 binding rules — default, implicit, explicit, new — plus arrow function lexical this.',
        href: '/javascript/this-binding',
      },
      {
        title: 'Prototypal Inheritance',
        description: 'The prototype chain, __proto__ vs prototype, and how ES6 classes map to prototypes.',
    ...
    items: [
      {
        ...
        description: 'Mark-and-sweep, generational GC, Scavenger vs Mark-Compact, and memory profiling.',
        href: '/javascript/garbage-collection',
      },
      {
        title: 'Module System (ESM vs CJS)',
        description: 'Static vs dynamic imports, tree-shaking, circular dependencies, and dual packages.',
        href: '/javascript/modules',
      },
      {
        title: 'Memory Leaks & Debugging',
        description: 'Detached DOM nodes, closures over large scopes, WeakRef, and Chrome DevTools heap snapshots.',
        href: '/javascript/memory-leaks',
      },
    ],
  },
];
      ...
      <div className="max-w-6xl">
        ...
        <div className="mb-10">
          ...
          <p className="text-text-secondary max-w-2xl leading-relaxed">
            Deep-dive into how the JavaScript engine actually runs your code — from the event loop and call stack to closures, prototypes, and memory
            management.
          </p>
        </div>
