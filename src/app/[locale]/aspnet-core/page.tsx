    ...
    items: [
      {
        ...
        description: 'How the middleware chain processes every HTTP request — ordering, branching, and short-circuiting.',
        href: '/aspnet-core/middleware',
      },
      {
        title: 'Routing & Endpoints',
        description: 'Route matching, attribute routing, minimal APIs, and endpoint metadata.',
        href: '/aspnet-core/routing',
      },
    ],
  },
  {
    ...
    items: [
      {
        ...
        description: 'JWT, Cookie, OAuth2 flows, claims-based identity, and policy-based authorization.',
        href: '/aspnet-core/authentication',
      },
    ],
  },
  {
    ...
    items: [
      {
        ...
        description: 'Constructor injection, service scopes per request, Singleton vs Scoped vs Transient.',
        href: '/aspnet-core/dependency-injection',
      },
      {
        title: 'Configuration & Options',
        description: 'appsettings.json, IOptions pattern, secrets management, and environment overrides.',
        href: '/aspnet-core/configuration',
      },
      {
        title: 'Logging & Diagnostics',
        description: 'ILogger pipeline, structured logging, OpenTelemetry, and distributed tracing.',
        href: '/aspnet-core/logging',
      },
    ],
  },
  {
    ...
    items: [
      {
        ...
        description: 'How request data maps to C# objects and validates them.',
        href: '/aspnet-core/model-binding',
      },
      {
        title: 'Filters',
        description: 'Pipeline interception — authorization, resource, action, exception, and result filters.',
        href: '/aspnet-core/filters',
      },
      { title: 'API Versioning', description: 'URL, query string, and header-based versioning strategies.', href: '/aspnet-core/api-versioning' },
      {
        ...
        description: 'RFC 7807 structured errors, global exception handling, and Problem Details.',
        href: '/aspnet-core/error-handling',
      },
    ],
  },
];
      ...
      <div className="max-w-6xl">
        <div className="mb-10">
          ...
          <p className="text-text-secondary max-w-2xl leading-relaxed">
            How HTTP requests flow through the ASP.NET Core pipeline — from middleware to endpoints, with authentication, DI, and error handling along
            the way.
          </p>
        </div>
        <CategoryConceptTree
          ...
          height={470}
          layoutConfig={{ ranksep: 95, nodesep: 65 }}
        />
