...
const sections = [
  {
    ...
    items: [
      { title: 'Scalability', description: 'Scaling strategies, stateless services, and session management.', href: '/system-design/scalability' },
      {
        ...
        description: 'L4 vs L7, health checks, sticky sessions, and NGINX vs ALB.',
        href: '/system-design/load-balancers',
      },
      {
        title: 'CDN & Edge Computing',
        description: 'Static asset distribution, edge functions, and cache invalidation.',
        href: '/system-design/cdn',
      },
    ],
  },
  {
    ...
    items: [
      {
        ...
        description: 'Redis, CDN, write-through vs write-back, and cache invalidation patterns.',
        href: '/system-design/caching',
      },
      {
        title: 'Rate Limiting & Throttling',
        description: 'Token bucket, sliding window, leaky bucket, and API quotas.',
        href: '/system-design/rate-limiting',
      },
    ],
  },
  {
    ...
    items: [
      {
        ...
        description: 'Horizontal partitioning, read replicas, CAP theorem, and consistency.',
        href: '/system-design/sharding',
      },
      {
        title: 'Message Queues & Pub/Sub',
        description: 'Kafka, RabbitMQ, at-least-once vs exactly-once delivery.',
        href: '/system-design/message-queues',
      },
      {
        title: 'Database Indexing Deep Dive',
        description: 'B-trees, hash indexes, composite indexes, and query plans.',
        href: '/system-design/indexing',
      },
    ],
  },
  {
    ...
    items: [
      {
        ...
        description: 'SSO, OAuth2 flows, session vs token, and distributed sessions.',
        href: '/system-design/auth-at-scale',
      },
      {
        title: 'Designing for Failure',
        description: 'Redundancy, failover, graceful degradation, and chaos engineering.',
        href: '/system-design/failure-design',
      },
    ],
  },
];
      ...
      <div className="max-w-6xl">
        <div className="mb-10">
          ...
          <p className="text-text-secondary max-w-2xl leading-relaxed">
            How large-scale systems are designed — from load balancing and caching to database sharding, message queues, and failure strategies.
          </p>
        </div>
        <CategoryConceptTree
          nodes={conceptNodes}
