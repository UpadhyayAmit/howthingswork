...
const sections = [
  {
    ...
    items: [
      {
        title: 'CLR Architecture',
        description: 'AppDomains, managed execution model, and the Common Language Runtime pipeline.',
        href: '/csharp-clr/clr-architecture',
      },
      {
        title: 'JIT Compilation',
        description: 'IL → native code, tiered compilation, ReadyToRun, and crossgen2.',
        href: '/csharp-clr/jit-visualizer',
      },
      { title: 'Garbage Collector', description: 'Generational GC, LOH, pinning, GC modes, and memory pressure.', href: '/csharp-clr/gc-visualizer' },
      {
        ...
        description: 'Stack vs heap allocation, boxing/unboxing costs, and Span<T>.',
        href: '/csharp-clr/value-reference-types',
      },
    ],
  },
  {
    ...
    items: [
      {
        ...
        description: 'How the compiler rewrites async methods into state machine classes.',
        href: '/csharp-clr/async-state-machine',
      },
      {
        title: 'LINQ Deferred Execution',
        description: 'IEnumerable pipeline, expression trees, and query provider model.',
        href: '/csharp-clr/linq-execution',
      },
      { title: 'Delegates & Events', description: 'Multicast delegates, event patterns, and lambda closures.', href: '/csharp-clr/delegates-events' },
      {
        ...
        description: 'Reified generics vs Java type erasure, constraints, and covariance.',
        href: '/csharp-clr/generics',
      },
    ],
  },
  {
    heading: 'Patterns & Advanced',
    badge: 'bg-emerald-500/15 text-emerald-400 border-emerald-500/30',
    items: [
      {
        title: 'DI Container & Service Lifetimes',
        description: 'Singleton vs Scoped vs Transient, captive dependencies, and disposal.',
        href: '/csharp-clr/dependency-injection',
      },
      {
        title: 'Reflection & Source Generators',
        description: 'Assembly inspection, metadata, and compile-time code generation.',
        href: '/csharp-clr/reflection',
      },
    ],
  },
];
      ...
      <div className="max-w-6xl">
        <div className="mb-10">
          ...
          <p className="text-text-secondary max-w-2xl leading-relaxed">
            How the .NET runtime executes your C# code — from JIT compilation and garbage collection to async state machines and generics.
          </p>
        </div>
        <CategoryConceptTree
          nodes={conceptNodes}
          ...
          title="CLR & C# Concept Map"
          height={440}
          layoutConfig={{ ranksep: 72, nodesep: 85 }}
        />
