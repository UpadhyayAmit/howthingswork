...
const groupColors: Record<string, string> = { foundation: "#8b5cf6", models: "#06b6d4", preprocessing: "#f59e0b", patterns: "#10b981", training: "#ec4899", deployment: "#3b82f6", frameworks: "#a855f7", ethics: "#ef4444" };

const sections = [
  { heading: "Foundations", badge: "bg-violet-500/15 text-violet-400 border-violet-500/30", items: [
    { title: "Neural Networks Basics", description: "Neurons, layers, activation functions, forward & backward propagation.", href: "/ai-ml/neural-networks" },
    { title: "Embeddings & Vector Databases", description: "Text → vectors, similarity search, Pinecone, Qdrant, and pgvector.", href: "/ai-ml/embeddings" },
    { title: "Transformer Architecture", description: "Self-attention, positional encoding, and why LLMs work so well.", href: "/ai-ml/transformers" },
    { title: "Tokenization & Context Windows", description: "BPE, SentencePiece, token limits, and context management strategies.", href: "/ai-ml/tokenization" },
  ]},
  { heading: "Patterns & Training", badge: "bg-emerald-500/15 text-emerald-400 border-emerald-500/30", items: [
    { title: "RAG Architecture", description: "Chunking, retrieval, prompt assembly, reranking, and evaluation.", href: "/ai-ml/rag" },
    { title: "Fine-Tuning vs Prompt Engineering", description: "LoRA, QLoRA, few-shot, system prompts — when to use which.", href: "/ai-ml/fine-tuning" },
  ...
  { heading: "Deployment & Ethics", badge: "bg-blue-500/15 text-blue-400 border-blue-500/30", items: [
    { title: "Model Serving & Inference", description: "ONNX, quantization, batch inference, latency budgets, and GPU optimization.", href: "/ai-ml/model-serving" },
    { title: "LangChain / Semantic Kernel", description: "Orchestration frameworks, chains, memory, and tool integration.", href: "/ai-ml/orchestration" },
    { title: "Responsible AI & Evaluation", description: "Hallucination detection, bias, safety guardrails, and eval metrics.", href: "/ai-ml/responsible-ai" },
  ]},
];
  ...
  return (
    <MotionFade>
      <div className="max-w-6xl">
        <div className="mb-10">
          <h1 className="text-3xl font-bold mb-3 tracking-tight" style={{ fontFamily: "var(--font-heading)" }}>AI & Machine Learning</h1>
          <p className="text-text-secondary max-w-2xl leading-relaxed">How AI systems work under the hood — from neural networks and transformers to RAG, agent patterns, and responsible deployment.</p>
        </div>
        <CategoryConceptTree nodes={conceptNodes} edges={conceptEdges} accentColor="#8b5cf6" groupColors={groupColors} title="AI/ML Concept Map" height={390} />
